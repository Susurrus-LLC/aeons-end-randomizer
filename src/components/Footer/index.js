  ...
  return (
    <footer className='footer'>
      ...
      <div className='pg-block'>
        <p className='pg-copyright'>This site was built by <a href='https://github.com/nai888' target='_blank' rel='noopener noreferrer'>Ian A.&nbsp;Cook</a>, copyright &copy; {years()} under the <a href='https://github.com/nai888/aeons-end-randomizer/blob/master/LICENSE' target='_blank' rel='noopener noreferrer'>AGPL-3.0 license</a>. The source code is available on GitHub at <a href='https://github.com/nai888/aeons-end-randomizer' target='_blank' rel='noopener noreferrer'>nai888/aeons-end-randomizer</a>.</p>
      </div>
    </footer>
  )
}
