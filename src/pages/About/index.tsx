...
const About = () => {
  const listSets = () => Data.SETS.filter(set => set.code !== 'PM').map((set) => (
  ...
  return (
    <Page>
      <h2>About</h2>
      <p>Aeon&rsquo;s End Randomizer is an unofficial app that can be used to randomize the setup for a game of Aeon&rsquo;s End. It will allow you to randomize your mage selection, nemesis selection, nemesis deck construction, and supply selection.</p>
      <h3>Supported Content</h3>
      <p>Aeon&rsquo;s End Randomizer supports all official content released so far, including {listSets()} and all promo cards.</p>
